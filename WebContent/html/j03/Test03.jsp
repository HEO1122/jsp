...
<%!
// 여기에 만들어지는 변수는
// 클래스 블럭 바로 아래에서 만들어지는 변수 즉 전역변수(멤버변수)가 된다.
	...
	<div class="w3-content mxw600 w3-center w3-margin-top">
		<h1 class="w3-margin-top w3-margin-button w3-deep-orange w3-padding w3-card-4">우 리 반 </h1>
