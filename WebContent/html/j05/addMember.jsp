...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#sbtn').click(function(){
			...
			var savt = $('#avt : checked').val(); //radio버튼으로 처리하는 경우
		...
		<form method="post" name="frm" id="frm">
			...
			<div class="w3-col w3-margin-top w3-card-4 w3-padding w3-round-large">
				...
				<div class="w3-col w3-margin-top w3-margin-bottom">
					<div id="avtfr">
						<label class="w3-col m3 w3-right-align w3-text-grey">아 바 타
							: </label>
					...
					<%-- <c:forEach var="i" begin="1" end="6" step="1">
						<div class="w3-col w3-center inblock">
							<img src="/cafe/img/avatar/img_avatar${i}.png">
							<div class="w3-col inblock">
								<input type="radio" name="avt" value="avt"><span>${i}</span>
							</div>
						</div>
					</c:forEach>	 --%>
					</div>
